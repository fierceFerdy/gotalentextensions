...
export class WelcomePanel {
    ...
    private async _getHtmlForWebview(webview: vscode.Webview): Promise<string> {
        ...
        const projectCards = projects.map(project => {
            ...
            const iconHtml = fs.existsSync(iconPath)
                ? `<img src="data:image/png;base64,${fs.readFileSync(iconPath).toString('base64')}" width="24" height="24" style="object-fit:contain;border-radius:4px">`
                : `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V9C21 7.89543 20.1046 7 19 7H12L10 5H5C3.89543 5 3 5.89543 3 7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
            return `
